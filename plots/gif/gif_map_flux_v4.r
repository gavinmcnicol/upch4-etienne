...
flux <- brick("../output/results/grids/v02/rf_mean_ch4_monthly_2001_2018_tg_month_composite.tif")

lw_cut <- 10^-5     # define low-end cutoff
...
# expression(10^{-2})
		...
		coord_equal() +
		gif_map_theme +      
		theme(	legend.position= c(0.0, 0.35),
				plot.margin = unit( c(1, -3, -2, 10) , "mm"))
...
},  movie.name = "/home/groups/robertj2/upch4/output/figures/monthly_ch4_compositech4_m_v200.gif", 
	ani.width=1000, ani.height=400, ani.res= 300, 
