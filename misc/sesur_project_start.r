# TODO: 
# DONE! - Mask land surface by wetland area
...
# DONE! - Make the time series plots  with stacked area 


# EF:  
#  DONE! - Upload other bioclimatic predictors.
#  DONE! - Rescale all predictors to 0-1 before distance calculation.
