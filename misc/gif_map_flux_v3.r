...
flux[flux < 0] = NA  # replace negative (sink) values
...
# Loop time steps
for (t in 1:48){ #length(names(flux))){
...
},  movie.name = "/home/groups/robertj2/upch4/output/figures/ch4_upscaled_v0262.gif", 
	ani.width=2500, ani.height=1800, ani.res= 600, 
