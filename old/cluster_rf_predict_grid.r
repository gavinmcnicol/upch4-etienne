...
dlwrf <- brick(paste0(dir, "merra2.0.5d.dlwrf.monthly.nc"), varname="dlwrf")[[1]]
dswrf <- stack(paste0(dir, "merra2.0.5d.dswrf.monthly.nc"), varname="dswrf")[[1]]
pre   <- stack(paste0(dir, "merra2.0.5d.pre.monthly.nc"), varname="pre")[[1]]
pres  <- stack(paste0(dir, "merra2.0.5d.pres.monthly.nc"), varname="pres")[[1]]
spfh  <- stack(paste0(dir, "merra2.0.5d.spfh.monthly.nc"), varname="spfh")[[1]]
tmp   <- stack(paste0(dir, "merra2.0.5d.tmp.monthly.nc"), varname="tmp")[[1]]
...
for (i in seq(1, length(min_since1980[1:4]))) {
  ...
  predictor_stack <-stack(dlwrf[[i]], dswrf[[i]], pre[[i]], 
                          pres[[i]], spfh[[i]], tmp[[i]], 
